"""
These submodules contain the classes for AllenNLP generators_discriminators,
all of which are subclasses of :class:`~allennlp.generators_discriminators.model.Model`.
"""
