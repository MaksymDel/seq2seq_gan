...
class Rnn2Rnn(Model):
    ...
    source_embedding : ``Embedding``, required
        Embedding for source side sequences
    target_embedding : ``Embedding``, required
        Embedding for target side sequences
    ...
    def decode(self, output_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        """
        predicted_indices = output_dict["ids"]
    ...
    def _prepare_output_projections(self,
        ...
        embedded_input = self._target_embedding(last_predictions)
